  ...
  hashPassword(password).then((hashedPassword) => {
    return db
      ...
      .then(([result]) => {
        ...
        return { firstname, lastname, city, language, email, password, id };
      });
  });
};
...
const verifyPassword = (plainPassword, dbhashedPassword) => {
  return argon2.verify(dbhashedPassword, plainPassword, hashingOptions);
};
